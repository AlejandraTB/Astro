...
1. **Intalación de Astro:** según indicaciones de Astro con npm.
2. **Creacíon de páginas:** nuevo archivo `.astro` en la carpeta `src/pages`.
3. **Creación de publicaciónes:** en formato Markdown.
